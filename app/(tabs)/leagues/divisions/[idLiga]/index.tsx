...
export default function index() {
    ...
    const { divisions, saveDivisions } = useDivisionStore()
    ...
    return (
      <>
        <Pressable className='p-3 w-12 bg-light-primary rounded-full items-center absolute right-3 bottom-3 z-50' onPress={() => router.push("/leagues/divisions/addDivision")}>
